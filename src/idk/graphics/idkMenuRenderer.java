...
public class idkMenuRenderer{
    ...
    private void generate(){
        ...
        Seq<Block> ores = Seq.with(Blocks.oreCopper, Blocks.oreLead, Blocks.oreScrap, Blocks.oreCoal, EarthBlocks.oreIron, EarthBlocks.oreLithium);
        shadows = new FrameBuffer(width, height);
        int offset = Mathf.random(100000);
        int s1 = offset, s2 = offset + 1, s3 = offset + 2;
        Block[] selected = Structs.random(
        new Block[]{EarthBlocks.Redsand, EarthBlocks.RedStonewall},
        new Block[]{EarthBlocks.RedStone, EarthBlocks.RedStonewall},
        new Block[]{EarthBlocks.RedishStone, EarthBlocks.RedishStoneWall}
        );
        ...
        for(int x = 0; x < width; x++){
            for(int y = 0; y < height; y++){
                ...
                if(Simplex.noise2d(s2, 2, 0.1, 1/10.0, x, y+9999999) > tr3){
                    ore = ore3;
                }
