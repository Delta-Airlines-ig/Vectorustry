...
//unit assembly
            ...
            size = 3;
            plans = (
             new Seq<AssemblerUnitPlan>(EarthUnitTypes.LCLW, 30f, PayloadStack.list(EarthUnitTypes.lightchasis, 1,  EarthBlocks.lightweapons, 1, EarthItems.iron, 50, EarthItems.steel, 25, Items.silicon, 25))//,
