 ...
 */
public class idkGenerator extends PlanetGenerator {
    //alternate, less direct generation (wip)
    public static boolean alt = false;
    static final int seed = 1;
    final Color idkMidColor = new Color();
    ...
    //^ EQUATOR
    //                  <- LOW                   HIGH ->
  // no clue what this does i just put random blocks in here
    Block[][] arr =
            {
                    {Redsand, ExposedStone, RedStone, RedishStone},
                    {Redsand, ExposedStone, RedStone, RedishStone},
                    {Redsand, ExposedStone, RedStone, RedishStone},
                    {Redsand, ExposedStone, RedStone, RedishStone},
                    {Redsand, ExposedStone, RedStone, RedishStone},
    ...
    protected void generate(){
        ...
        Seq<Block> ores = Seq.with(Blocks.oreCopper, oreIron);
