...
public class Vars2 implements Loadable{
    ...
    public static final String appName = "Mindustry but worse";
    /** Github API URL. */
    ...
    public static final float turnDuration = 1 * Time.toMinutes;
    /** chance of an invasion per turn, 1 = 100% */
    public static final float baseInvasionChance = 50f / 100f;
    /** how many minutes have to pass before invasions in a *captured* sector start */
    public static final float invasionGracePeriod = 1;
    /** min armor fraction damage; e.g. 0.05 = at least 5% damage */
    public static final float minArmorDamage = 0.1f;
    /** land/launch animation duration */
    public static final float coreLandDuration = 320f;
